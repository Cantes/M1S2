...
public:
    ...
    //===================affichage et histogramme - tp1=====================
	void affichePix (bool ligne, int indice_ligne);
	void histo ();

	//===================Erosion, dilatation - tp2====================================
	ImageBase erosion ();
	ImageBase dilatation (ImageBase img);
	ImageBase inversion (ImageBase img);
