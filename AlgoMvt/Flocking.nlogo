...
;to-report angleSeparate
;  let va vectFromAngle average-flockmate-heading 1
;  let vs vectFromAngle ([heading] of nearest-neighbor) 1
;  let vc vectFromAngle average-heading-towards-flockmates 1
;  
;  set va multiplyScalarvect factor-align va
;  set vs multiplyScalarvect factor-separate vs
;  set vc multiplyScalarvect factor-cohere vc
;  
;  let vr additionvect va vs
;  set vr additionvect vr vc
;  report vr
;  let a atn item 0  vr item 1 vr
;end
